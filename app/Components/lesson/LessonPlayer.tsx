...
export default function LessonPlayer({
  ...
  const quickCheckProgressPercentage =
    totalQuickChecks > 0
      ? Math.round(
          (completedQuickChecks / totalQuickChecks) * 100
        )
      : 100;
  ...
  const handleAnswerSelect = (answer: string) => {
    ...
    if (isCorrect && !alreadyAnsweredCorrectly) {
      setBonusXp(
        (previousXp) =>
          previousXp +
          (currentStep.quickCheck?.xpReward ?? 5)
      );
    }
  };
      ...
      >
        <section className={styles.completeCard}>
          ...
          <p className={styles.completeDescription}>
            ...
            {lesson.xpReward ?? 100} XP, and your progress
            has been saved.
          </p>
      ...
      <section className={styles.body}>
        ...
        {totalQuickChecks > 0 && (
          <section className={styles.quickCheckOverview}>
            <div
              className={styles.quickCheckOverviewHeading}
            >
              <div>
            ...
            <div className={styles.interactiveHeading}>
              <div>
                ...
                <p className={styles.quickCheckCounter}>
                  {completedQuickChecks} of {totalQuickChecks}{" "}
                  complete · {quickChecksRemaining} remaining
                </p>
              </div>
